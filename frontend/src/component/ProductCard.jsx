  ...
  return (
    <div className="relative bg-white rounded-2xl shadow-md p-4 w-full max-w-xs flex flex-col">
      ...
      <p className="text-gray-500 text-sm mb-4 flex items-center">
        Price per &nbsp;<span className="text-green-500">{unit}</span>
      </p>
      ...
      <div className="mt-auto flex items-center justify-between">
        ...
        <button className="flex items-center gap-1 bg-green-100 text-green-600 px-4 py-2 rounded-full font-medium hover:bg-green-200 transition cursor-pointer">
