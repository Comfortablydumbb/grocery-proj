      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
        ...
        >
          ...
          <p className="text-gray-700 mb-4">
            Fresh Market began with a simple idea: to create a grocery store
            that feels like a community market. In 2010, founders Sarah and
            Michael Chen noticed their neighborhood lacked a store offering
            quality produce at reasonable prices with a personal touch.
          </p>
          <p className="text-gray-700 mb-4">
            What started as a small corner store has grown into a beloved chain
            serving communities across the region. Despite our growth, we've
            maintained our commitment to quality, freshness, and personalized
            service.
          </p>
          <p className="text-gray-700">
            Through relationships with local farmers and producers, we've
            created a grocery experience that celebrates both global flavors and
            local harvests.
          </p>
        </motion.div>
